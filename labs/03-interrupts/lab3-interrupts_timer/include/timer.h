...
#define TIM0_overflow_1ms()   TCCR0B &= ~((1<<CS02)); TCCR0B |= (1<<CS00) | (1<<CS01)
...
/** @brief Set overflow 128us, prescaler 010 --> 2 */
#define TIM2_overflow_128us()   TCCR2B &= ~((1<<CS22) | (1<<CS20)); TCCR2B |= (1<<CS21)
/** @brief Set overflow 512us, prescaler 011 --> 3 */
#define TIM2_overflow_512us()   TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);
/** @brief Set overflow 1ms, prescaler 100 --> 4 */
#define TIM2_overflow_1ms()   TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);
/** @brief Set overflow 2ms, prescaler 101 --> 5 */
#define TIM2_overflow_2ms()   TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);
/** @brief Set overflow 4ms, prescaler 110 --> 6 */
#define TIM2_overflow_4ms()   TCCR2B &= ~(1<<CS20); TCCR2B |= (1<<CS22) | (1<<CS21);
/** @brief Set overflow 16ms, prescaler 111 --> 7 */
